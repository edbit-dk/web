    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-signin" role="form" method="post" action="" data-parsley-validate>
                ...
                <input type="text" name="user_login"  class="form-control" placeholder="* Brugernavn" data-parsley-trigger="keyup" data-parsley-minlength="6" data-parsley-maxlength="20" data-parsley-validation-threshold="10" data-parsley-minlength-message = "Mindst 6 karaktere" required="" autofocus="">
