...
<div class="line inner-content content-wrapper">
    ...
    <div class="ad-wrapper">
        ...
        foreach ($cats1 as $cat1) {
            ...
            <div class="unit size1of3">
                <img src="<?php echo URL_UPLOADS ?><?php if (isset($cat1->image)) echo $cat1->image; ?>">
                <div class="ad-price ">
                ...
                <div class="ad-more">
                    <a href="<?php echo URL . 'car/detail/' . $cat1->ID; ?>"><h3>Se alle informationer</h3></a>
                </div>
                <?php
                if ($user->role('Admin')) {
                    ?>
                    <div class="ad-more">
                        <a href="<?php echo URL . 'controlpanel/edit/' . $cat1->ID; ?>"><h3>Opdatér oplysninger</h3></a>
                    </div>
                    <?php
                }
                ?>
    ...
    <div class="ad-wrapper">
        ...
        foreach ($cats2 as $cat2) {
            ...
            ?>
            <div class="unit size1of3 ">
                <img src="<?php echo URL; ?>uploads/<?php if (isset($cat2->image)) echo $cat2->image; ?>">
                <div class="ad-price ">
                    <h2><?php if (isset($price)) echo number_format($price, 0, ',', '.'); ?> DKK</h2>
                </div>
                <div class="ad-comment ">
                ...
                <div class="ad-more">
                    <a href="<?php echo URL . 'car/detail/' . $cat2->ID; ?>"><h3>Se alle informationer</h3></a>
                </div>
                <?php
                if ($user->role('Admin')) {
                    ?>
                    <div class="ad-more">
                        <a href="<?php echo URL . 'controlpanel/edit/' . $cat2->ID; ?>"><h3>Opdatér oplysninger</h3></a>
                    </div>
                    <?php
                }
                ?>
    ...
    <div class="ad-wrapper">
        ...
        foreach ($cats3 as $cat3) {
            ...
            ?>
            <div class="unit size1of3 ">
                <img src="<?php echo URL; ?>uploads/<?php if (isset($cat3->image)) echo $cat3->image; ?>">
                <div class="ad-price ">
                    <h2><?php if (isset($price)) echo number_format($price, 0, ',', '.'); ?> DKK</h2>
                </div>
                <div class="ad-comment ">
                ...
                <div class="ad-more">
                    <a href="<?php echo URL . 'car/detail/' . $cat3->ID; ?>"><h3>Se alle informationer</h3></a>
                </div>
                <?php
                if ($user->role('Admin')) {
                    ?>
                    <div class="ad-more">
                        <a href="<?php echo URL . 'controlpanel/edit/' . $cat3->ID; ?>"><h3>Opdatér oplysninger</h3></a>
                    </div>
                    <?php
                }
                ?>
