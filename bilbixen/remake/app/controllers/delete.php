...
class Delete extends Controller {
    ...
    public function message($ID) {
        if (Input::exists()) {
            ...
            Session::flash('errors', '<p style="color: green;">Message removed successfully!</p>');
            Redirect::to(URL . 'controlpanel/messages');
        } else {
            require_once TEMPLATES . 'backend/header.php';
            ?>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <p>Are you sure you want to delete message <?php echo $ID; ?>?</p>
                <form method="post" action="">
                    <input class="btn btn-danger" type="submit" name="submit" value="Yes">
                </form>
                <a class="btn btn-success" href="<?php echo URL; ?>controlpanel/messages">Nej</a>
            </div>
            <?php
            require_once TEMPLATES . 'backend/footer.php';
        }
