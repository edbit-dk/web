<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <p><a class="btn btn-primary" href="<?php echo URL; ?>controlpanel/create/car">Ny Annonce</a></p>
    ...
    <table class="table table-striped" border='1'>
        ...
        if (!empty($data->cars)) {
            foreach ($data->cars as $car) {
                ...
                echo "<td><a class='btn btn-success' href='" . URL . "controlpanel/editcar/" . $car->ID . "'>Opdatér</td>";
