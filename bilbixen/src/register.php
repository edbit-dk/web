...
if (isset($_POST['submit'])) {
    ...
    if ($check->rowCount() > 0) {
        ...
        $query = $handler->prepare("INSERT INTO users( 
	...
	:pass
        ...
        $query->bindValue(':name', $_POST['user_name'], PDO::PARAM_STR);
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-signin" role="form" method="post" action="" data-parsley-validate>
                ...
                <input type="text" name="user_name"  class="form-control" placeholder="* Brugernavn" data-parsley-trigger="keyup" data-parsley-minlength="6" data-parsley-maxlength="20" data-parsley-validation-threshold="10" data-parsley-minlength-message = "Mindst 6 karaktere" required="" autofocus="">
                <input type="password" name="user_pass"  class="form-control" data-parsley-trigger="keyup" data-parsley-minlength="6" data-parsley-maxlength="20" data-parsley-validation-threshold="10" data-parsley-minlength-message = "Mindst 6 karaktere" placeholder="* Adgangskode" required="">
