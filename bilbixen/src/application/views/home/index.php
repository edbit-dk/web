...
<div class="content">
    <div class="inner-content-center small-heading">
        ...
        <img src="<?php echo URL; ?>public/img/layout/icons.png">
    </div>
</div>
<!--Content end-->
    ...
    <div class="line ad-wrapper">    
            <?php foreach ($cars as $car) { 
                ...
                <div class="unit size1of3 ">
                    <img src="<?php echo URL; ?>public/img/cars/<?php if (isset($car->image)) echo $car->image; ?>">
                    <div class="ad-price ">
                    ...
                    <div class="ad-more">
                        <a href="<?php echo URL . 'cars/detail/' . $car->id; ?>"><h3>Se alle informationer</h3></a>
                    </div>
                </div>
            <?php
            }
