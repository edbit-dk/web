<?php
// Heading
$_['heading_title'] = 'Quickpay ViaBill';

// Text 
$_['text_payment'] = 'Payment';
$_['text_success'] = 'Success: You have modified Quickpay Checkout account details!';
$_['text_quickpay_viabill'] = '<a onclick="window.open(\'http://quickpay.dk/about/\');"><img style="background:#28303a;" src="http://quickpay.net/gfx/layout/logo-inverse-sm.png" alt="Quickpay" title="Quickpay" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['tooltip_md5check'] = 'Indtast din Quickpay MD5 nøgle';
$_['tooltip_protocol'] = 'Indtast Quickpay protokol. Anbefalet: 7';
...
$_['tooltip_splitpayment'] = 'Aktiver split betalinger';
