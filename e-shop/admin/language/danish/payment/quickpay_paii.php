<?php
// Heading
$_['heading_title'] = 'Quickpay Paii';

// Text 
$_['text_payment'] = 'Payment';
$_['text_success'] = 'Success: You have modified Quickpay Checkout account details!';
$_['text_quickpay_paii'] = '<a onclick="window.open(\'http://quickpay.dk/about/\');"><img style="background:#28303a;" src="http://quickpay.net/gfx/layout/logo-inverse-sm.png" alt="Quickpay" title="Quickpay" style="border: 1px solid #EEEEEE;" /></a>';
