  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-quickpay_paii" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-quickpay_paii" class="form-horizontal">
        	...
        	<div class="form-group">
	            ...
	            <div class="col-sm-10">
					<select id="select-status" name="quickpay_paii_status" class="form-control">
						<?php if ($quickpay_paii_status) { ?>
	        ...
	        <div class="form-group required">
	        	...
	        	<div class="col-sm-10">
	        		 <input type="text" name="quickpay_paii_protocol" value="<?php echo $quickpay_paii_protocol; ?>"  id="input-protocol" class="form-control" />
	        ...
	        <div class="form-group required">
	        	...
	        	<div class="col-sm-10">
	        		 <input type="text" name="quickpay_paii_msgtype" value="<?php echo $quickpay_paii_msgtype; ?>"  id="input-msgtype" class="form-control" />
	        ...
	        <div class="form-group required">
	        	...
	        	<div class="col-sm-10">
	        		 <input type="text" name="quickpay_paii_merchant" value="<?php echo $quickpay_paii_merchant; ?>" id="input-merchant" class="form-control" />
	        ...
	        <div class="form-group required">
	        	...
	        	<div class="col-sm-10">
					<select id="select-language" name="quickpay_paii_language"  class="form-control">
					<?php
					foreach ($languages as $key => $value) {
						if ($key == $quickpay_paii_language) { ?>
	        ...
	        <div class="form-group required">
	        	...
	        	<div class="col-sm-10">
	        		 <input type="text" name="quickpay_paii_md5check" value="<?php echo $quickpay_paii_md5check; ?>" id="input-md5check" class="form-control" />
	        ...
	        <div class="form-group">
	        	...
	        	<div class="col-sm-10">
					<?php 
					if ($quickpay_paii_autocapture) { ?>
							<input type="radio" name="quickpay_paii_autocapture" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="quickpay_paii_autocapture" value="0" />
						<?php echo $text_no;
						} else { ?>
							<input type="radio" name="quickpay_paii_autocapture" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="quickpay_paii_autocapture" value="0" checked="checked" />
						<?php echo $text_no;
					} 
					?>
	        	</div>
	        ...
	        <div class="form-group">
	        	...
	        	<div class="col-sm-10">
					<?php if ($quickpay_paii_splitpayment) { ?>
						<input type="radio" name="quickpay_paii_splitpayment" value="1" checked="checked" />
						<?php echo $text_yes; ?>
						<input type="radio" name="quickpay_paii_splitpayment" value="0" />
						<?php echo $text_no;
						} else { ?>
						<input type="radio" name="quickpay_paii_splitpayment" value="1" />
						<?php echo $text_yes; ?>
						<input type="radio" name="quickpay_paii_splitpayment" value="0" checked="checked" />
						<?php echo $text_no;
					} ?>
	        	</div>
	        </div>  
	        ...
	        <div class="form-group">
	        	...
	        	<div class="col-sm-10">
					<select name="quickpay_paii_order_status_completed" class="form-control">
						<?php
						foreach ($order_statuses as $order_status) {
							if ($order_status['order_status_id'] == $quickpay_paii_order_status_completed) { ?>
