...
if ($user->isLoggedIn()) {
    ...
    <footer >
        ...
        <h2 data-sr="enter bottom and scale up 20% over 2s">CONTROLPANEL</h2>
        ...
        <form class="form-signin container " method="post" action="<?php echo URL; ?>create/competition" onsubmit="return confirm('Are you sure you want to make this participant winner?')">
        ...
        <h2 class="center">Create Newsletter</h2>
