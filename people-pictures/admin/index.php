          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <span class="text-muted">
              	              <?php
          $result = $handler->query('select count(*) from pp_celebs')->fetchColumn(); 
			echo $result;
              ?>
              </span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <span class="text-muted">
              	              <?php
          $result = $handler->query('select count(*) from pp_news')->fetchColumn(); 
			echo $result;
              ?>
              </span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <span class="text-muted">
              	              <?php
          $result = $handler->query('select count(*) from pp_gallery')->fetchColumn(); 
			echo $result;
              ?>
              </span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <span class="text-muted">
              	              <?php
          $result = $handler->query('select count(*) from pp_movies')->fetchColumn(); 
			echo $result;
              ?>
              </span>
            </div>
