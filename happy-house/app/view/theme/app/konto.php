    ...
    <div class="content-wrapper-less">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <br>
                <ul>
                    <li><a class="base-typo-color" href="<?php echo $this->project_url; ?>konto/oplysninger">Brugeroplysninger</a></li>
                    <br>
                    <li><a class="base-typo-color" href="<?php echo $this->project_url; ?>konto/favoritter">Favoritter</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    if (!empty($this->data->saves[0]))
                    {
                        ...
                        {
                            ?>
                            <a href="<?php echo $this->project_url; ?>bolig/<?php echo $view->ID; ?>">
                ...
                if (!empty($this->data->saves[0]))
                {
                    ...
                    <div class=" text-center">
                        <ul class="pagination">
                            ...
                            {
                                if ($this->current_url == $this->project_url . 'konto/favoritter/' . $x)
                                {
                                    ?> 
                                    <li><a class="pager-active" href="<?php echo $this->project_url; ?>boliger/alle/<?php echo $x; ?>"><?php echo $x; ?></a></li>
                                        <?php
                                    }
                                    else
                                    {
                                        ?> 
                                    <li><a href="<?php echo $this->project_url; ?>boliger/<?php echo Session::get('ORDER') . '/' . $x; ?>"><?php echo $x; ?></a></li>
                                    <?php
                                }
                            }
                            ?>
                ...
                if (!empty($this->data->user[0]))
                {
                    ...
                    foreach ($this->data->user as $user)
                    {
                        ...
                        Form::input('text', 'full_name', $user->Firstname . ' ' . $user->Lastname, "class='form-control' required");
                        ...
                        Form::input('text', 'org', $user->Org, "class='form-control' required");
