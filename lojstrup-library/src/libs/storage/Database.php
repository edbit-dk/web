...
class Database implements SQLInterface
{
    ...
    public
            function __construct($type = DB_TYPE, $server = DB_HOST,
            $database = DB_NAME, $user = DB_USER, $password = DB_PASS)
    {
        try
            {
            $this->_pdo = new PDO($type . ':host=' . $server . ';dbname=' . $database,
                    $user, $password);
  ...
  public static
    ...
    public
            function query($sql, $params = array(), $searchParams = array(),
    ...
    public
            function action($action, $table, $where = array(), $options = null,
            $searchQuery = null, $searchTerms = null)
    {
    ...
    public
            ...
            $options = null, $searchQuery = null)
    {
        return $this->action('SELECT ' . implode($select, ', '), $table, $where,
                        $options, $searchQuery, $select);
    }
    ...
    public
            function search($searchTerms = array(), $searchQuery)
    {
        $query = "";
